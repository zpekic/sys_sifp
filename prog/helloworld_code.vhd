...
-- L0034@000D 01BF.  data16 =  @GetCursorXY - $;
...
-- L0039@0012 01B2.  data16 =  @GetOldCrsXY - $;
--  data16 = 0000000110110010;
18 => X"01B2",

-- L0040@0013 0042.  CPX, M[POP];
--  r_p = 0000, r_a = 000, r_x = 001, r_y = 000, r_s = 010;
19 => X"0" & O"0" & O"1" & O"0" & O"2",

-- L0041@0014 000A.  CPY, M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 001, r_s = 010;
20 => X"0" & O"0" & O"0" & O"1" & O"2",

-- L0042@0015 B000.  IF_XZ;
--  r_p = 1011, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
21 => X"B" & O"0" & O"0" & O"0" & O"0",

-- L0043@0016 0003.  data16 =  @CheckY - $;
--  data16 = 0000000000000011;
22 => X"0003",

-- L0044@0017 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
23 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0045@0018 000E.  data16 =  @Revert - $;
--  data16 = 0000000000001110;
24 => X"000E",

-- L0046@0019 D000.CheckY:  IF_YZ;
--  r_p = 1101, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
25 => X"D" & O"0" & O"0" & O"0" & O"0",

-- L0047@001A 0003.  data16 =  @Flip - $;
--  data16 = 0000000000000011;
26 => X"0003",

-- L0048@001B 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
27 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0049@001C 000A.  data16 =  @Revert - $;
--  data16 = 0000000000001010;
28 => X"000A",

-- L0051@001D 6003.Flip:  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
29 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0052@001E 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
30 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0053@001F 01B6.  data16 =  @GetRowBase - $;
--  data16 = 0000000110110110;
31 => X"01B6",

-- L0054@0020 09B0.  LDA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 100, r_x = 110, r_y = 110, r_s = 000;
32 => X"0" & O"4" & O"6" & O"6" & O"0",

-- L0055@0021 1200.  r_p = M[IMM], r_a = XOR;
--  r_p = 0001, r_a = 001, r_x = 000, r_y = 000, r_s = 000;
33 => X"1" & O"1" & O"0" & O"0" & O"0",

-- L0056@0022 0080.  data16 =  0x0080;
--  data16 = 0000000010000000;
34 => X"0080",

-- L0057@0023 0FB0.  STA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 111, r_x = 110, r_y = 110, r_s = 000;
35 => X"0" & O"7" & O"6" & O"6" & O"0",

-- L0058@0024 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
36 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0059@0025 000E.  data16 =  @IntExit - $;
--  data16 = 0000000000001110;
37 => X"000E",

-- L0061@0026 6003.Revert:  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
38 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0062@0027 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
39 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0063@0028 01AD.  data16 =  @GetRowBase - $;
--  data16 = 0000000110101101;
40 => X"01AD",

-- L0064@0029 09B0.  LDA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 100, r_x = 110, r_y = 110, r_s = 000;
41 => X"0" & O"4" & O"6" & O"6" & O"0",

-- L0065@002A 1C00.  r_p = M[IMM], r_a = AND;
--  r_p = 0001, r_a = 110, r_x = 000, r_y = 000, r_s = 000;
42 => X"1" & O"6" & O"0" & O"0" & O"0",

-- L0066@002B FF7F.  data16 =  0xFF7F;
--  data16 = 1111111101111111;
43 => X"FF7F",

-- L0067@002C 0FB0.  STA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 111, r_x = 110, r_y = 110, r_s = 000;
44 => X"0" & O"7" & O"6" & O"6" & O"0",

-- L0068@002D 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
45 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0069@002E 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
46 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0070@002F 019D.  data16 =  @GetCursorXY - $;
--  data16 = 0000000110011101;
47 => X"019D",

-- L0071@0030 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
48 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0072@0031 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
49 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0073@0032 011F.  data16 =  @SetOldCrsXY - $;
--  data16 = 0000000100011111;
50 => X"011F",

-- L0075@0033 0022.IntExit:  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
51 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0076@0034 0102.  r_x = LDX, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 100, r_y = 000, r_s = 010;
52 => X"0" & O"0" & O"4" & O"0" & O"2",

-- L0077@0035 0802.  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
53 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0078@0036 0002.  r_p = NOP, r_a = NOA, r_x = NOX, r_y = NOY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
54 => X"0" & O"0" & O"0" & O"0" & O"2",

-- L0079@0037 4002.  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
55 => X"4" & O"0" & O"0" & O"0" & O"2",

-- L0082@0038 6003.Init:  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
56 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0083@0039 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
57 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0084@003A 00C6.  data16 =  @VGA_Init - $;
--  data16 = 0000000011000110;
58 => X"00C6",

-- L0085@003B 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
59 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0086@003C 0060.  data16 =  @StrHWorld;
--  data16 = 0000000001100000;
60 => X"0060",

-- L0087@003D 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
61 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0088@003E 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
62 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0089@003F 019D.  data16 =  @VGA_OutStr - $;
--  data16 = 0000000110011101;
63 => X"019D",

-- L0091@0040 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
64 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0092@0041 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
65 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0093@0042 008C.  data16 =  @UART_Init - $;
--  data16 = 0000000010001100;
66 => X"008C",

-- L0094@0043 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
67 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0095@0044 0060.  data16 =  @StrHWorld;
--  data16 = 0000000001100000;
68 => X"0060",

-- L0096@0045 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
69 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0097@0046 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
70 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0098@0047 00B0.  data16 =  @UART_OutStr - $;
--  data16 = 0000000010110000;
71 => X"00B0",

-- L0101@0048 0FFF.  r_p = NOP, r_a = A, r_x = X, r_y = Y, r_s = S;
--  r_p = 0000, r_a = 111, r_x = 111, r_y = 111, r_s = 111;
72 => X"0" & O"7" & O"7" & O"7" & O"7",

-- L0103@0049 6003.EchoLoop:  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
73 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0104@004A 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
74 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0105@004B 008C.  data16 =  @UART_GetChr - $;
--  data16 = 0000000010001100;
75 => X"008C",

-- L0106@004C 0E03.EchoOut:  r_a = STA, r_s = M[PUSH];
--  r_p = 0000, r_a = 111, r_x = 000, r_y = 000, r_s = 011;
76 => X"0" & O"7" & O"0" & O"0" & O"3",

-- L0107@004D 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
77 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0108@004E 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
78 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0109@004F 0099.  data16 =  @UART_OutChr - $;
--  data16 = 0000000010011001;
79 => X"0099",

-- L0110@0050 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
80 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0111@0051 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
81 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0112@0052 00CA.  data16 =  @VGA_OutChr - $;
--  data16 = 0000000011001010;
82 => X"00CA",

-- L0113@0053 0802.  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
83 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0114@0054 1200.  r_p = M[IMM], r_a = XOR;
--  r_p = 0001, r_a = 001, r_x = 000, r_y = 000, r_s = 000;
84 => X"1" & O"1" & O"0" & O"0" & O"0",

-- L0115@0055 000D.  data16 =  0xD;
--  data16 = 0000000000001101;
85 => X"000D",

-- L0116@0056 9000.  IF_AZ;
--  r_p = 1001, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
86 => X"9" & O"0" & O"0" & O"0" & O"0",

-- L0117@0057 0003.  data16 =  @EchoLF - $;
--  data16 = 0000000000000011;
87 => X"0003",

-- L0118@0058 3000.  JUMP;
--  r_p = 0011, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
88 => X"3" & O"0" & O"0" & O"0" & O"0",

-- L0119@0059 0049.  data16 =  @EchoLoop;
--  data16 = 0000000001001001;
89 => X"0049",

-- L0120@005A 1800.EchoLF:  r_p = M[IMM], r_a = LDA;
--  r_p = 0001, r_a = 100, r_x = 000, r_y = 000, r_s = 000;
90 => X"1" & O"4" & O"0" & O"0" & O"0",

-- L0121@005B 000A.  data16 =  0xA;
--  data16 = 0000000000001010;
91 => X"000A",

-- L0122@005C 3000.  JUMP;
--  r_p = 0011, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
92 => X"3" & O"0" & O"0" & O"0" & O"0",

-- L0123@005D 004C.  data16 =  @EchoOut;
--  data16 = 0000000001001100;
93 => X"004C",

-- L0125@005E 0001.StrClear:  data16 =  0x1;
--  data16 = 0000000000000001;
94 => X"0001",

-- L0126@005F 0000.  data16 =  0;
--  data16 = 0000000000000000;
95 => X"0000",

-- L0128@0060 0048.StrHWorld:  data16 =  'H';
--  data16 = 0000000001001000;
96 => X"0048",

-- L0129@0061 0065.  data16 =  'e';
--  data16 = 0000000001100101;
97 => X"0065",

-- L0130@0062 006C.  data16 =  'l';
--  data16 = 0000000001101100;
98 => X"006C",

-- L0131@0063 006C.  data16 =  'l';
--  data16 = 0000000001101100;
99 => X"006C",

-- L0132@0064 006F.  data16 =  'o';
--  data16 = 0000000001101111;
100 => X"006F",

-- L0133@0065 0020.  data16 =  ' ';
--  data16 = 0000000000100000;
101 => X"0020",

-- L0134@0066 0057.  data16 =  'W';
--  data16 = 0000000001010111;
102 => X"0057",

-- L0135@0067 006F.  data16 =  'o';
--  data16 = 0000000001101111;
103 => X"006F",

-- L0136@0068 0072.  data16 =  'r';
--  data16 = 0000000001110010;
104 => X"0072",

-- L0137@0069 006C.  data16 =  'l';
--  data16 = 0000000001101100;
105 => X"006C",

-- L0138@006A 0064.  data16 =  'd';
--  data16 = 0000000001100100;
106 => X"0064",

-- L0139@006B 0021.  data16 =  '!';
--  data16 = 0000000000100001;
107 => X"0021",

-- L0140@006C 000D.StrEnd:  data16 =  0xD;
--  data16 = 0000000000001101;
108 => X"000D",

-- L0141@006D 000A.  data16 =  0xA;
--  data16 = 0000000000001010;
109 => X"000A",

-- L0142@006E 0000.  data16 =  0;
--  data16 = 0000000000000000;
110 => X"0000",
...
-- 32 location(s) in following ranges will be filled with default value
-- 0003 .. 0007
-- 01E5 .. 01FF
