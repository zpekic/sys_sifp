...
-- L0028@0008 0163.  data16 =  @VGA_OutStr - $;
--  data16 = 0000000101100011;
8 => X"0163",
...
-- L0042@00C2 0094.  data16 =  @VGA_HOME - $;
...
-- L0048@00C7 0071.  data16 =  @VGA_CLS - $;
--  data16 = 0000000001110001;
199 => X"0071",
...
-- L0052@00CA 0091.  data16 =  @GetCursorXY - $;
...
-- L0064@00D4 0061.  data16 =  @VGA_LF - $;
--  data16 = 0000000001100001;
212 => X"0061",

-- L0066@00D5 0806.  LDA, M[S];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 110;
213 => X"0" & O"4" & O"0" & O"0" & O"6",

-- L0067@00D6 1200.  r_p = M[IMM], r_a = XOR;
--  r_p = 0001, r_a = 001, r_x = 000, r_y = 000, r_s = 000;
214 => X"1" & O"1" & O"0" & O"0" & O"0",

-- L0068@00D7 0008.  data16 =  0x8;
--  data16 = 0000000000001000;
215 => X"0008",

-- L0069@00D8 9000.  IF_AZ;
--  r_p = 1001, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
216 => X"9" & O"0" & O"0" & O"0" & O"0",

-- L0070@00D9 0000.  data16 =  $VGA_BS - $;
--  data16 = 0000000000000000;
217 => X"0000",

-- L0073@00DA 0802.  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
218 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0075@00DB 0000.VGA_Print:  NOP;
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
219 => X"0" & O"0" & O"0" & O"0" & O"0",

-- L0076@00DC 003B.  r_y = STY, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 111, r_s = 011;
220 => X"0" & O"0" & O"0" & O"7" & O"3",

-- L0077@00DD 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
221 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0078@00DE 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
222 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0079@00DF 0085.  data16 =  @GetRowBase - $;
--  data16 = 0000000010000101;
223 => X"0085",

-- L0080@00E0 0FB0.  STA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 111, r_x = 110, r_y = 110, r_s = 000;
224 => X"0" & O"7" & O"6" & O"6" & O"0",

-- L0081@00E1 00A2.  INX, r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 010, r_y = 100, r_s = 010;
225 => X"0" & O"0" & O"2" & O"4" & O"2",

-- L0082@00E2 1040.  r_p = M[IMM], r_x = CPX;
--  r_p = 0001, r_a = 000, r_x = 001, r_y = 000, r_s = 000;
226 => X"1" & O"0" & O"1" & O"0" & O"0",

-- L0083@00E3 0040.  data16 =  64;
--  data16 = 0000000001000000;
227 => X"0040",

-- L0084@00E4 A000.  IF_X_GE;
--  r_p = 1010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
228 => X"A" & O"0" & O"0" & O"0" & O"0",

-- L0085@00E5 000C.  data16 =  @NextRow - $;
--  data16 = 0000000000001100;
229 => X"000C",

-- L0086@00E6 003B.SetCursorXY:  r_y = STY, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 111, r_s = 011;
230 => X"0" & O"0" & O"0" & O"7" & O"3",

-- L0087@00E7 1020.  r_p = M[IMM], r_y = LDY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 100, r_s = 000;
231 => X"1" & O"0" & O"0" & O"4" & O"0",

-- L0088@00E8 FF3E.  data16 =  0xFF00 + 62;
--  data16 = 1111111100111110;
232 => X"FF3E",

-- L0089@00E9 01F0.  STX, M[Y];
--  r_p = 0000, r_a = 000, r_x = 111, r_y = 110, r_s = 000;
233 => X"0" & O"0" & O"7" & O"6" & O"0",

-- L0090@00EA 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
234 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0091@00EB FF3F.  data16 =  0xFF00 + 63;
--  data16 = 1111111100111111;
235 => X"FF3F",

-- L0092@00EC 0022.  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
236 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0093@00ED 01B8.  STY, M[X];
--  r_p = 0000, r_a = 000, r_x = 110, r_y = 111, r_s = 000;
237 => X"0" & O"0" & O"6" & O"7" & O"0",

-- L0095@00EE 0022.  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
238 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0096@00EF 0102.  r_x = LDX, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 100, r_y = 000, r_s = 010;
239 => X"0" & O"0" & O"4" & O"0" & O"2",

-- L0097@00F0 4002.  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
240 => X"4" & O"0" & O"0" & O"0" & O"2",

-- L0099@00F1 1100.NextRow:  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
241 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0100@00F2 0000.  data16 =  0;
--  data16 = 0000000000000000;
242 => X"0000",

-- L0101@00F3 0010.NextRow1:  INY;
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 010, r_s = 000;
243 => X"0" & O"0" & O"0" & O"2" & O"0",

-- L0102@00F4 1008.  r_p = M[IMM], r_y = CPY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 001, r_s = 000;
244 => X"1" & O"0" & O"0" & O"1" & O"0",

-- L0103@00F5 0020.  data16 =  32;
--  data16 = 0000000000100000;
245 => X"0020",

-- L0104@00F6 C000.  IF_Y_GE;
--  r_p = 1100, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
246 => X"C" & O"0" & O"0" & O"0" & O"0",

-- L0105@00F7 0003.  data16 =  @ScrollUp - $;
--  data16 = 0000000000000011;
247 => X"0003",

-- L0106@00F8 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
248 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0107@00F9 FFED.  data16 =  @SetCursorXY - $;
--  data16 = 1111111111101101;
249 => X"FFED",

-- L0109@00FA 1020.ScrollUp:  r_p = M[IMM], r_y = LDY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 100, r_s = 000;
250 => X"1" & O"0" & O"0" & O"4" & O"0",

-- L0110@00FB 0000.  data16 =  0;
--  data16 = 0000000000000000;
251 => X"0000",

-- L0111@00FC 003B.NxtRow:  r_y = STY, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 111, r_s = 011;
252 => X"0" & O"0" & O"0" & O"7" & O"3",

-- L0112@00FD 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
253 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0113@00FE 0000.  data16 =  0;
--  data16 = 0000000000000000;
254 => X"0000",

-- L0114@00FF 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
255 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0115@0100 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
256 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0116@0101 0063.  data16 =  @GetRowBase - $;
--  data16 = 0000000001100011;
257 => X"0063",

-- L0117@0102 003B.NxtCol:  r_y = STY, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 111, r_s = 011;
258 => X"0" & O"0" & O"0" & O"7" & O"3",

-- L0118@0103 1028.  r_p = M[IMM], r_y = ADY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 101, r_s = 000;
259 => X"1" & O"0" & O"0" & O"5" & O"0",

-- L0119@0104 0040.  data16 =  64;
--  data16 = 0000000001000000;
260 => X"0040",

-- L0120@0105 09B0.  LDA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 100, r_x = 110, r_y = 110, r_s = 000;
261 => X"0" & O"4" & O"6" & O"6" & O"0",

-- L0121@0106 0022.  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
262 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0122@0107 0FB0.  STA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 111, r_x = 110, r_y = 110, r_s = 000;
263 => X"0" & O"7" & O"6" & O"6" & O"0",

-- L0123@0108 0080.  INX;
--  r_p = 0000, r_a = 000, r_x = 010, r_y = 000, r_s = 000;
264 => X"0" & O"0" & O"2" & O"0" & O"0",

-- L0124@0109 1040.  r_p = M[IMM], r_x = CPX;
--  r_p = 0001, r_a = 000, r_x = 001, r_y = 000, r_s = 000;
265 => X"1" & O"0" & O"1" & O"0" & O"0",

-- L0125@010A 0040.  data16 =  64;
--  data16 = 0000000001000000;
266 => X"0040",

-- L0126@010B A000.  IF_X_GE;
--  r_p = 1010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
267 => X"A" & O"0" & O"0" & O"0" & O"0",

-- L0127@010C 0003.  data16 =  @ChkRow - $;
--  data16 = 0000000000000011;
268 => X"0003",

-- L0128@010D 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
269 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0129@010E FFF4.  data16 =  @NxtCol - $;
--  data16 = 1111111111110100;
270 => X"FFF4",

-- L0130@010F 0022.ChkRow:  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
271 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0131@0110 0010.  INY;
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 010, r_s = 000;
272 => X"0" & O"0" & O"0" & O"2" & O"0",

-- L0132@0111 1008.  r_p = M[IMM], r_y = CPY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 001, r_s = 000;
273 => X"1" & O"0" & O"0" & O"1" & O"0",

-- L0133@0112 001F.  data16 =  32 - 1;
--  data16 = 0000000000011111;
274 => X"001F",

-- L0134@0113 C000.  IF_Y_GE;
--  r_p = 1100, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
275 => X"C" & O"0" & O"0" & O"0" & O"0",

-- L0135@0114 0003.  data16 =  @ClrLastRow - $;
--  data16 = 0000000000000011;
276 => X"0003",

-- L0136@0115 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
277 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0137@0116 FFE6.  data16 =  @NxtRow - $;
--  data16 = 1111111111100110;
278 => X"FFE6",

-- L0139@0117 0000.ClrLastRow:  NOP;
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
279 => X"0" & O"0" & O"0" & O"0" & O"0",

-- L0140@0118 1020.  r_p = M[IMM], r_y = LDY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 100, r_s = 000;
280 => X"1" & O"0" & O"0" & O"4" & O"0",

-- L0141@0119 001F.  data16 =  32 - 1;
--  data16 = 0000000000011111;
281 => X"001F",

-- L0142@011A 003B.  r_y = STY, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 111, r_s = 011;
282 => X"0" & O"0" & O"0" & O"7" & O"3",

-- L0143@011B 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
283 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0144@011C 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
284 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0145@011D 002C.  data16 =  @ClearRow - $;
--  data16 = 0000000000101100;
285 => X"002C",

-- L0146@011E 0022.  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
286 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0147@011F 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
287 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0148@0120 0002.  data16 =  @SetX0 - $;
--  data16 = 0000000000000010;
288 => X"0002",

-- L0150@0121 0802.VGA_CR:  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
289 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0151@0122 1100.SetX0:  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
290 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0152@0123 0000.  data16 =  0;
--  data16 = 0000000000000000;
291 => X"0000",

-- L0153@0124 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
292 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0154@0125 FFC1.  data16 =  @SetCursorXY - $;
--  data16 = 1111111111000001;
293 => X"FFC1",

-- L0156@0126 0802.VGA_BS:  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
294 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0157@0127 1040.  r_p = M[IMM], r_x = CPX;
--  r_p = 0001, r_a = 000, r_x = 001, r_y = 000, r_s = 000;
295 => X"1" & O"0" & O"1" & O"0" & O"0",

-- L0158@0128 0000.  data16 =  0;
--  data16 = 0000000000000000;
296 => X"0000",

-- L0159@0129 B000.  IF_XZ;
--  r_p = 1011, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
297 => X"B" & O"0" & O"0" & O"0" & O"0",

-- L0160@012A 0003.  data16 =  @PrevRow - $;
--  data16 = 0000000000000011;
298 => X"0003",

-- L0161@012B 20C0.  DEX, BRANCH;
--  r_p = 0010, r_a = 000, r_x = 011, r_y = 000, r_s = 000;
299 => X"2" & O"0" & O"3" & O"0" & O"0",

-- L0162@012C FFBA.  data16 =  @SetCursorXY - $;
--  data16 = 1111111110111010;
300 => X"FFBA",

-- L0163@012D 1008.PrevRow:  r_p = M[IMM], r_y = CPY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 001, r_s = 000;
301 => X"1" & O"0" & O"0" & O"1" & O"0",

-- L0164@012E 0000.  data16 =  0;
--  data16 = 0000000000000000;
302 => X"0000",

-- L0165@012F D000.  IF_YZ;
--  r_p = 1101, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
303 => X"D" & O"0" & O"0" & O"0" & O"0",

-- L0166@0130 FFB6.  data16 =  @SetCursorXY - $;
--  data16 = 1111111110110110;
304 => X"FFB6",

-- L0167@0131 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
305 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0168@0132 003F.  data16 =  64 - 1;
--  data16 = 0000000000111111;
306 => X"003F",

-- L0169@0133 2018.  DEY, BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 011, r_s = 000;
307 => X"2" & O"0" & O"0" & O"3" & O"0",

-- L0170@0134 FFB2.  data16 =  @SetCursorXY - $;
--  data16 = 1111111110110010;
308 => X"FFB2",

-- L0172@0135 0802.VGA_LF:  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
309 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0173@0136 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
310 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0174@0137 FFBC.  data16 =  @NextRow1 - $;
--  data16 = 1111111110111100;
311 => X"FFBC",

-- L0176@0138 0802.VGA_CLS:  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
312 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0177@0139 1800.  r_p = M[IMM], r_a = LDA;
--  r_p = 0001, r_a = 100, r_x = 000, r_y = 000, r_s = 000;
313 => X"1" & O"4" & O"0" & O"0" & O"0",

-- L0178@013A 0020.  data16 =  ' ';
--  data16 = 0000000000100000;
314 => X"0020",

-- L0179@013B 1020.  r_p = M[IMM], r_y = LDY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 100, r_s = 000;
315 => X"1" & O"0" & O"0" & O"4" & O"0",

-- L0180@013C 0000.  data16 =  0;
--  data16 = 0000000000000000;
316 => X"0000",

-- L0181@013D 003B.ClrNextRow:  r_y = STY, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 111, r_s = 011;
317 => X"0" & O"0" & O"0" & O"7" & O"3",

-- L0182@013E 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
318 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0183@013F 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
319 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0184@0140 0009.  data16 =  @ClearRow - $;
--  data16 = 0000000000001001;
320 => X"0009",

-- L0185@0141 0022.  r_y = LDY, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 100, r_s = 010;
321 => X"0" & O"0" & O"0" & O"4" & O"2",

-- L0186@0142 0010.  INY;
--  r_p = 0000, r_a = 000, r_x = 000, r_y = 010, r_s = 000;
322 => X"0" & O"0" & O"0" & O"2" & O"0",

-- L0187@0143 1008.  r_p = M[IMM], r_y = CPY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 001, r_s = 000;
323 => X"1" & O"0" & O"0" & O"1" & O"0",

-- L0188@0144 0020.  data16 =  32;
--  data16 = 0000000000100000;
324 => X"0020",

-- L0189@0145 C000.  IF_Y_GE;
--  r_p = 1100, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
325 => X"C" & O"0" & O"0" & O"0" & O"0",

-- L0190@0146 0011.  data16 =  @vga_home1 - $;
--  data16 = 0000000000010001;
326 => X"0011",

-- L0191@0147 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
327 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0192@0148 FFF5.  data16 =  @ClrNextRow - $;
--  data16 = 1111111111110101;
328 => X"FFF5",

-- L0194@0149 6003.ClearRow:  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
329 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0195@014A 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
330 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0196@014B 0019.  data16 =  @GetRowBase - $;
--  data16 = 0000000000011001;
331 => X"0019",

-- L0197@014C 1800.  r_p = M[IMM], r_a = LDA;
--  r_p = 0001, r_a = 100, r_x = 000, r_y = 000, r_s = 000;
332 => X"1" & O"4" & O"0" & O"0" & O"0",

-- L0198@014D 0020.  data16 =  ' ';
--  data16 = 0000000000100000;
333 => X"0020",

-- L0199@014E 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
334 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0200@014F 0007.  data16 =  64 / 8 - 1;
--  data16 = 0000000000000111;
335 => X"0007",

-- L0201@0150 0FB0.ClrRLoop:  STA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 111, r_x = 110, r_y = 110, r_s = 000;
336 => X"0" & O"7" & O"6" & O"6" & O"0",

-- L0202@0151 B000.  IF_XZ;
--  r_p = 1011, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
337 => X"B" & O"0" & O"0" & O"0" & O"0",

-- L0203@0152 0003.  data16 =  @ClrDone - $;
--  data16 = 0000000000000011;
338 => X"0003",

-- L0204@0153 20C0.  DEX, BRANCH;
--  r_p = 0010, r_a = 000, r_x = 011, r_y = 000, r_s = 000;
339 => X"2" & O"0" & O"3" & O"0" & O"0",

-- L0205@0154 FFFC.  data16 =  @ClrRLoop - $;
--  data16 = 1111111111111100;
340 => X"FFFC",

-- L0206@0155 4002.ClrDone:  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
341 => X"4" & O"0" & O"0" & O"0" & O"2",

-- L0208@0156 0802.VGA_HOME:  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
342 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0209@0157 1120.vga_home1:  LDX, LDY, M[IMM];
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 100, r_s = 000;
343 => X"1" & O"0" & O"4" & O"4" & O"0",

-- L0210@0158 0000.  data16 =  0;
--  data16 = 0000000000000000;
344 => X"0000",

-- L0211@0159 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
345 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0212@015A FF8C.  data16 =  @SetCursorXY - $;
--  data16 = 1111111110001100;
346 => X"FF8C",

-- L0214@015B 1020.GetCursorXY:  r_p = M[IMM], r_y = LDY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 100, r_s = 000;
347 => X"1" & O"0" & O"0" & O"4" & O"0",

-- L0215@015C FF3E.  data16 =  0xFF00 + 62;
--  data16 = 1111111100111110;
348 => X"FF3E",

-- L0216@015D 0130.  LDX, M[Y];
--  r_p = 0000, r_a = 000, r_x = 100, r_y = 110, r_s = 000;
349 => X"0" & O"0" & O"4" & O"6" & O"0",

-- L0217@015E 01C3.  r_x = STX, r_s = M[PUSH];
--  r_p = 0000, r_a = 000, r_x = 111, r_y = 000, r_s = 011;
350 => X"0" & O"0" & O"7" & O"0" & O"3",

-- L0218@015F 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
351 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0219@0160 FF3F.  data16 =  0xFF00 + 63;
--  data16 = 1111111100111111;
352 => X"FF3F",

-- L0220@0161 01A0.  LDY, M[X];
--  r_p = 0000, r_a = 000, r_x = 110, r_y = 100, r_s = 000;
353 => X"0" & O"0" & O"6" & O"4" & O"0",

-- L0221@0162 0102.  r_x = LDX, r_s = M[POP];
--  r_p = 0000, r_a = 000, r_x = 100, r_y = 000, r_s = 010;
354 => X"0" & O"0" & O"4" & O"0" & O"2",

-- L0222@0163 4002.  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
355 => X"4" & O"0" & O"0" & O"0" & O"2",

-- L0224@0164 0E03.GetRowBase:  r_a = STA, r_s = M[PUSH];
--  r_p = 0000, r_a = 111, r_x = 000, r_y = 000, r_s = 011;
356 => X"0" & O"7" & O"0" & O"0" & O"3",

-- L0225@0165 1028.  r_p = M[IMM], r_y = ADY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 101, r_s = 000;
357 => X"1" & O"0" & O"0" & O"5" & O"0",

-- L0226@0166 FF00.  data16 =  0xFF00 + 0;
--  data16 = 1111111100000000;
358 => X"FF00",

-- L0227@0167 0830.  LDA, M[Y];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 110, r_s = 000;
359 => X"0" & O"4" & O"0" & O"6" & O"0",

-- L0228@0168 0E20.  LDY, A;
--  r_p = 0000, r_a = 111, r_x = 000, r_y = 100, r_s = 000;
360 => X"0" & O"7" & O"0" & O"4" & O"0",

-- L0229@0169 0802.  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
361 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0230@016A 4002.  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
362 => X"4" & O"0" & O"0" & O"0" & O"2",

-- L0232@016B 0980.VGA_OutStr:  LDA, M[X];
--  r_p = 0000, r_a = 100, r_x = 110, r_y = 000, r_s = 000;
363 => X"0" & O"4" & O"6" & O"0" & O"0",

-- L0233@016C 9000.  IF_AZ;
--  r_p = 1001, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
364 => X"9" & O"0" & O"0" & O"0" & O"0",

-- L0234@016D 0006.  data16 =  @OutStrDone - $;
--  data16 = 0000000000000110;
365 => X"0006",

-- L0235@016E 6003.  r_p = STP2, r_s = M[PUSH];
--  r_p = 0110, r_a = 000, r_x = 000, r_y = 000, r_s = 011;
366 => X"6" & O"0" & O"0" & O"0" & O"3",

-- L0236@016F 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
367 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0237@0170 FF4C.  data16 =  @VGA_OutChr - $;
--  data16 = 1111111101001100;
368 => X"FF4C",

-- L0238@0171 2080.  INX, BRANCH;
--  r_p = 0010, r_a = 000, r_x = 010, r_y = 000, r_s = 000;
369 => X"2" & O"0" & O"2" & O"0" & O"0",

-- L0239@0172 FFF9.  data16 =  @VGA_OutStr - $;
--  data16 = 1111111111111001;
370 => X"FFF9",

-- L0240@0173 4002.OutStrDone:  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
371 => X"4" & O"0" & O"0" & O"0" & O"2",

-- L0242@0174 0E03.VGATest:  r_a = STA, r_s = M[PUSH];
--  r_p = 0000, r_a = 111, r_x = 000, r_y = 000, r_s = 011;
372 => X"0" & O"7" & O"0" & O"0" & O"3",

-- L0243@0175 1020.  r_p = M[IMM], r_y = LDY;
--  r_p = 0001, r_a = 000, r_x = 000, r_y = 100, r_s = 000;
373 => X"1" & O"0" & O"0" & O"4" & O"0",

-- L0244@0176 1000.  data16 =  0x1000;
--  data16 = 0001000000000000;
374 => X"1000",

-- L0245@0177 1100.  r_p = M[IMM], r_x = LDX;
--  r_p = 0001, r_a = 000, r_x = 100, r_y = 000, r_s = 000;
375 => X"1" & O"0" & O"4" & O"0" & O"0",

-- L0246@0178 0000.  data16 =  0;
--  data16 = 0000000000000000;
376 => X"0000",

-- L0247@0179 09C0.VGATLoop:  LDA, X;
--  r_p = 0000, r_a = 100, r_x = 111, r_y = 000, r_s = 000;
377 => X"0" & O"4" & O"7" & O"0" & O"0",

-- L0248@017A 0A06.  ADC, M[S];
--  r_p = 0000, r_a = 101, r_x = 000, r_y = 000, r_s = 110;
378 => X"0" & O"5" & O"0" & O"0" & O"6",

-- L0249@017B 0FB0.  STA, r_x = M[X], r_y = M[Y];
--  r_p = 0000, r_a = 111, r_x = 110, r_y = 110, r_s = 000;
379 => X"0" & O"7" & O"6" & O"6" & O"0",

-- L0250@017C 0080.  INX;
--  r_p = 0000, r_a = 000, r_x = 010, r_y = 000, r_s = 000;
380 => X"0" & O"0" & O"2" & O"0" & O"0",

-- L0251@017D 1040.  r_p = M[IMM], r_x = CPX;
--  r_p = 0001, r_a = 000, r_x = 001, r_y = 000, r_s = 000;
381 => X"1" & O"0" & O"1" & O"0" & O"0",

-- L0252@017E 0800.  data16 =  64 * 32;
--  data16 = 0000100000000000;
382 => X"0800",

-- L0253@017F A000.  IF_X_GE;
--  r_p = 1010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
383 => X"A" & O"0" & O"0" & O"0" & O"0",

-- L0254@0180 0003.  data16 =  @VGATestEx - $;
--  data16 = 0000000000000011;
384 => X"0003",

-- L0255@0181 2000.  BRANCH;
--  r_p = 0010, r_a = 000, r_x = 000, r_y = 000, r_s = 000;
385 => X"2" & O"0" & O"0" & O"0" & O"0",

-- L0256@0182 FFF7.  data16 =  @VGATLoop - $;
--  data16 = 1111111111110111;
386 => X"FFF7",

-- L0257@0183 0802.VGATestEx:  r_a = LDA, r_s = M[POP];
--  r_p = 0000, r_a = 100, r_x = 000, r_y = 000, r_s = 010;
387 => X"0" & O"4" & O"0" & O"0" & O"2",

-- L0258@0184 4002.  r_p = LDP, r_s = M[POP];
--  r_p = 0100, r_a = 000, r_x = 000, r_y = 000, r_s = 010;
388 => X"4" & O"0" & O"0" & O"0" & O"2",

-- 123 location(s) in following ranges will be filled with default value
-- 0185 .. 01FF
